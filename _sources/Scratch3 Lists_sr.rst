...
У време док се види облачак |think_sec| у белом облаку на средини позорнице појављује се храна коју мачак замишља.
...
У Скречу постоји и могућност да се лик умножава и за време извршавања програма. (Слично као што у листе могу да се уписују елементи и у време креирања и за време извршавања програма.) За клонирање лика и управљање понашањем клона користе се инструкције |create_clone| и |when_clone| из групе *Управљање*.
...
Напомена. Ако се пројекат користи за увежбавање сабирања и одузимања бројева до 10 корисно је уметнути „празно“ питање |ask_wait|  у скрипту мале чаробнице 
уместо задршке блоком |wait_sec| . Тек када дете да одговор притиснућемо дирку *Enter* и проверити одговор. 
...
**New concepts**:  листа, елемент листе, умножак (клон).

**Strach commands**: |variables_blocks| - |add_to|,  |delete_of|, |delete_all|, |insert_at|,  |replace_with|, |show_list|, |hide_list|, |item_of|,  |length_of|,  |item_index|, |list_contains|; 
