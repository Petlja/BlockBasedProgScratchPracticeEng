...
.. reveal:: објашњење
   ...
   .. |izraz1| image:: ../_images/7/fig7_21.png
   ...
   а) Узмемо блок  |izraz4| из групе блокова *Осећаји*. 
   ...
   а) Узмемо блок |puta|  из групе блокова *Операције*

   б) Поставимо први аргумент који смо добили по опису 1 у прво поље  |izraz7|
   ...
   4. Коначно, овако формиран аргумент поставимо у поље блока |zamisli|
...
**Наредбе**: |promenljive| - |neka_var|, |promeni_var|, |pokazi_var| , |sakrij_var|.
 
**Функцијски блокови**: |operatori| - |plus|, |minus|, |puta|, |povezi|, |mod|, |funkcija|
