...
.. topic:: Блокови који омогућавају понављање
 ...
 На пример, ако желимо да постигнемо илузију да мачак хода, балерина игра или лептир лети, довољно је да им придружите скрипту у којој се у бесконачном циклусу понављају наредбе |next_costume| и |wait_sec|. 
...
|1| Алатком |v_select| селектујемо цео лик
...
.. topic::  Задатак 1
 ...
 Напиши програм који ће нацртати 4 звезде различитих боја величине 120 пиксела једну поред друге од левог до десног руба екрана. Цртање реализовати коришћењем наредбе |stamp|. 
 ...
 Блок |repeat| из групе *Управљање* омогућава да само једном напишемо групу наредби и задамо колико пута их треба поновити. 
...
Example 2 - Пројекат „Геометријске фигуре” 
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Наредба за уношење податка |ask_wait| налази се у групи *Осећаји*.

По извршењу ове наредбе Скреч памти шта је корисник унео у простору који се зове |answer|.
...
.. mchoice:: ciklus04
   ...
   :answer_d: 
   :correct: a, c
   :feedback_a: Овакво мењање координате х доводи до померања лика лево-десно.  
   :feedback_b: Променом координате у постиже се да лик иде горе-доле.
   :feedback_c: Лик стално иде лево-десно.
   :feedback_d: Променом усмерења постиже се да лик гледа лево-десно.

   Извршавањем којег од бесконачних циклуса се постиже да лик иде лево-десно и гледа удесно, 
   ако су претходно извршене наредбе |goto_xy|, |point_towards| и |rotation_style|? (Изабери све тачне одговоре).
...
.. mchoice:: ciklus05
   ...
   :answer_d: 
   :correct: b, d
   :feedback_a: Лик се окреће у круг.
   :feedback_b: Овакво мењање координате у доводи до померања лика горе-доле.
   :feedback_c: Смењују се положаји ногама налево и ногама надесно.
   :feedback_d: Кад је начин окретања на све стране, извршавање овог блок наредби доводи управо до описаног понашања.

   Којим од следећих бесконачних циклуса се постиже да лик стално смењује два положаја: ногама надоле и ногама нагоре, 
   ако су претходно извршене наредбе |goto_xy|, |point_towards| и |rotation_style2|? (Изабери све тачне одговоре).
...
.. mchoice:: repeat2
   ...
   :answer_d: ниједног
   :correct: a
   :feedback_a: Одмах је испуњен услов за излазак из циклуса.
...
.. reveal:: сакривање10
   ...
   **Одговор:**
   ...
   То може да поправити укључивањем наредбе |rotation_style| у скрипту лика.
...
**Strach commands**: |control_blocks| - |forever|, |repeat|, |repeat_until|; |pen_extension| - |stamp|; 
